...
import com.example.BibliotecaRouter.usecase.UseCaseListarRecurso;
...
public class ConsultarRecursoRouter {
    @Bean
    public RouterFunction<ServerResponse> ListarTodosRecuso(UseCaseListarRecurso useCaseListarRecurso){
